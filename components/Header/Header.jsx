...
const Header = ({ placeholder }) => {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
      ...
      {/* Middle */}
      <div className="relative flex items-center md:border-2 md:shadow-sm rounded-full py-2 ">
        <input 
      ...
      {searchInput && 
        <div className="absolute top-[100%] -my-5 mx-auto left-[50%] transform translate-x-[-50%] shadow-xl bg-white">
          <DateRangePicker
